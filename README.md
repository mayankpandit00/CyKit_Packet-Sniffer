# CyKit Series  
## 4) Packet Sniffer
A pthon program in cybersecurity kit series that sniffs the packets of an interface.
Combined with arp_spoofer.py, it can harvest out the urls that the user vists and possible credentials of the victim.
...
5. Usage : 
   1. sudo python packet_sniffer.py -i [interface]
